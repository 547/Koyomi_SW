...
class ViewController: UIViewController {
    ...
    @IBOutlet fileprivate weak var koyomi: Koyomi! {
        didSet {
            ...
            koyomi.selectionMode = .multiple(style: .oval)
            koyomi.selectedStyleColor = UIColor(red: 17/255, green: 96/255, blue: 136/255, alpha: 1)
            koyomi
                .setDayFont(size: 10)
                .setWeekFont(size: 10)
        }
    ...
    @IBOutlet fileprivate weak var currentDateLabel: UILabel! {
           didSet {
               currentDateLabel.font = UIFont.boldSystemFont(ofSize: 15)
               currentDateLabel.textColor = UIColor(red: 17/255, green: 96/255, blue: 136/255, alpha: 1)
           }
       }
   ...
   @IBOutlet weak var customButton: MyButton! {
       didSet {
           customButton.deepColor = UIColor.Color.lightGray
       }
   }
...
extension ViewController {
    ...
    @IBAction func tappedCustom(_ sender: AnyObject) {
        let mainColor = UIColor(red: 245/255, green: 252/255, blue: 255/255, alpha: 1)
        let style = KoyomiStyle.custom(customColor: KoyomiStyle.CustomColorScheme(dayBackgrond: mainColor,
        weekBackgrond: mainColor,
        week: UIColor(red: 74/255, green: 74/255, blue: 74/255, alpha: 1),
        weekday: UIColor(red: 155/255, green: 155/255, blue: 155/255, alpha: 1),
        holiday: (saturday: UIColor(red: 155/255, green: 155/255, blue: 155/255, alpha: 1), sunday: UIColor(red: 155/255, green: 155/255, blue: 155/255, alpha: 1)),
        otherMonth: UIColor(red: 225/255, green: 228/255, blue: 231/255, alpha: 1),
        separator: UIColor(red: 216/255, green: 216/255, blue: 216/255, alpha: 1)))
        configureStyle(style)
    }
    @IBAction func tappedSelectedCurrent(_ sender: AnyObject) {
        koyomi.select(date: Date()).reloadData()
    }
